...
The FanPot factory was deployed on Arc Mainnet by the organizer in [transaction `0xc4ce…5892`](https://explorer.arc.io/tx/0xc4ce06ea92cfae48ee95fcba9cdaa04e5904c17881a2fed34cac85e0b2865892). Its deployed address is [`0x8D8a…77Ab6`](https://explorer.arc.io/address/0x8D8a8bEdE436bfF36E70d261E2041dA6F6777Ab6). The receipt succeeded, creation input matches the checked-in bytecode and constructor arguments, and onchain owner, reviewer, and USDC match the plan. The [Mainnet manifest](../apps/web/data/arc-mainnet-deployment.json) records this evidence. Anyone can rerun `pnpm verify:factory`; the deployment consumed 0.066433538 USDC in gas. No Mainnet campaign has been created or contributed to yet. `pnpm verify:proof` intentionally fails until it verifies organizer allowlisting, campaign creation, reviewer activation, and a real USDC contribution as well.

MetaMask marked the production domain **Malicious / unsafe** at wallet connection. Wallet actions on `/launch` are paused while the cause is investigated; see the [wallet warning investigation](wallet-warning-investigation.md). The exact classification reason is not yet known; absence from the repository's public blocklist does not prove a false positive. Do not bypass the warning or sign further transactions until resolved.
