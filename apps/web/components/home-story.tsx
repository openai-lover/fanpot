...
const sceneCopy = [
  ...
  { kicker: '06 / THE VISION', title: 'Imagine it across the city.', body: 'One small idea grows into a city-scale screen. This AI-generated placement is a concept; no ad has been booked.', detail: 'LUMI is a fictional artist and the large city billboard is an AI-generated concept.' },
] as const;
    ...
    <section className="story-track" ref={trackRef} aria-label="How a FanPot comes together">
      <div className="story-sticky" ref={stageRef} aria-hidden="true">
        ...
        <div className="story-reality" aria-hidden="true">
          ...
          <svg className="story-real-mobile" viewBox="0 0 941 1672" preserveAspectRatio="xMidYMid slice"><defs><clipPath id="story-mobile-screen"><rect x="50" y="749" width="860" height="439" /></clipPath></defs><image href="/arc-demo/story-megascreen-mobile-v1.png" width="941" height="1672" /><image className="story-real-art" href="/arc-demo/ad-artwork-idol-v2.jpg" x="50" y="749" width="860" height="439" preserveAspectRatio="xMidYMid slice" clipPath="url(#story-mobile-screen)" /><rect className="story-real-target" ref={mobileTargetRef} x="42" y="738" width="877" height="460" fill="transparent" /></svg>
        </div>
